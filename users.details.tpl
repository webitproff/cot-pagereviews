    ...
    <div class="container-xl min-height-50vh">
        ...
        <div class="tabs">
            <ul class="nav nav-tabs mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link<!-- IF {PHP.tab} == 'portfolio' --> active<!-- ENDIF -->" href="{USERS_DETAILS_FOLIO_URL}#tab_portfolio" data-bs-toggle="tab" role="tab">{PHP.L.folio} {USERS_DETAILS_FOLIO_COUNT}</a>
                </li>
                <!-- ENDIF -->
                <!-- IF {PHP|cot_module_active('market')} -->
                <li class="nav-item">
                    <a class="nav-link<!-- IF {PHP.tab} == 'market' --> active<!-- ENDIF -->" href="{USERS_DETAILS_MARKET_URL}#tab_market" data-bs-toggle="tab" role="tab">{PHP.L.market} {USERS_DETAILS_MARKET_COUNT}</a>
                </li>
                <!-- ENDIF -->
                ...
                <li class="nav-item">
                    <a class="nav-link<!-- IF {PHP.tab} == 'pagereviews' --> active<!-- ENDIF -->" href="{USERS_DETAILS_PAGEREVIEWS_URL}#tab_pagereviews" data-bs-toggle="tab" role="tab">
                        {PHP.L.pagereviews_reviews} ({USERS_DETAILS_PAGEREVIEWS_COUNT})
                    </a>
                </li>
                <!-- ENDIF -->
            </ul>
            ...
            <div class="tab-content">
                                    ...
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <div>
                                            <a
                                                ...
                                                href="{USERS_DETAILS_ID|cot_url('users','m=edit&id=$this')}"
                                                data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                                title="Администрирование профиля «{USERS_DETAILS_NICKNAME}»"
                                            >
                ...
                <div class="tab-pane fade<!-- IF {PHP.tab} == 'portfolio' --> show active<!-- ENDIF -->" id="tab_portfolio" role="tabpanel">
                    {PORTFOLIO}
                </div>
                <div class="tab-pane fade<!-- IF {PHP.tab} == 'market' --> show active<!-- ENDIF -->" id="tab_market" role="tabpanel">
                    {MARKET}
                </div>
