...
$L['pagereviews_date'] = 'Дата';
$L['pagereviews_author'] = 'Автор';
...
$L['pagereviews_review_title'] = 'Заголовок отзыва';
$L['pagereviews_review_text'] = 'Текст отзыва';
$L['pagereviews_complaints'] = 'Жалобы';
...
$L['pagereviews_review_title'] = 'Отзыв';
$L['pagereviews_page'] = 'Статья';
$L['pagereviews_actions'] = 'Действия';
...
$L['pagereviews_score_titles'] = ['1 звезда (Крайне отрицательно)', '2 звезды (Плохо)', '3 звезды (Нейтрально)', '4 звезды (Хорошо)', '5 звезд (Отлично)'];
