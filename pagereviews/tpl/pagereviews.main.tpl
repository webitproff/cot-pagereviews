    ...
    <div class="col-12 col-lg-8 mx-auto mb-5">
      <div class="card">
        <div class="card-body">
          ...
          <div class="mb-3">
            <small class="text-muted"> {PHP.L.pagereviews_author}: <a href="{REVIEW_AUTHOR_URL}">{REVIEW_AUTHOR}</a> | {PHP.L.pagereviews_date}: {REVIEW_DATE} | {PHP.L.pagereviews_page}: <a href="{REVIEW_PAGE_URL}">{REVIEW_PAGE_TITLE}</a>
            </small>
          </div>
          <div class="row g-3 justify-content-md-end justify-content-center">
            ...
            <div class="col-md-3 col-12 text-center">
              <a href="{REVIEW_COMPLAINT_URL}" class="btn w-100 btn-warning btn-sm">
                ...
                </span> {PHP.L.pagereviews_submit_complaint} </a>
            </div>
            <!-- ENDIF -->
